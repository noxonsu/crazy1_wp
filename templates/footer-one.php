			...
			<footer class="<?php if( $home_h == 1 ) { echo "pt150 "; } ?>jarallax"<?php if(get_theme_mod('background_p')!="") { ?> style="background-image: url(<?php echo get_theme_mod('background_p'); ?>);"<?php } ?>>
               ...
               <?php if( get_theme_mod('linkto1')!="" or get_theme_mod('linkto2')!="" or get_theme_mod('linkto3')!="" or get_theme_mod('linkto4')!="" or get_theme_mod('linkto5')!="" or  get_theme_mod('copyright')) { ?> 
				<div class="container">
					<div class="footer-inner clearfix">
						...
						<?php if( $home_h == 1 ) { ?><div class="border-top"></div><?php } ?>
