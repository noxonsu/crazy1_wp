			...
			<div class="title-home jarallax" style="background-image: url(<?php echo get_field( "background_image0" ); ?>);">
				...
				<div class="container">
					...
					<div class="text-left">
						<h1 data-sr><?php echo get_post_meta($post->ID, 'header0', true); ?>
							<span class="color typed-two">&nbsp;</span>
						</h1>
						<em data-sr><?php echo get_post_meta($post->ID, 'text0', true); ?></em>
						<div class="buttons mt40 mb160">
			...
			<main>
							...
							<div class="info-block-wrap clearfix">
								...
								<div class="col-md-7">
									<div class="info-block sm-mb30">
										...
										<div class="mt40">
											<a href="<?php echo get_post_meta($post->ID, 'link1', true); ?>" class="btn animsition-link line-hor">
                            ...
                            <?php if( have_rows('slider3') ): while( have_rows('slider3') ) : the_row(); ?>
								<div class="owl-item">
									...
									<div class="col-md-6 col-md-offset-1">
										...
										<div class="mt40">
											<a href="<?php the_sub_field('link3'); ?>" class="btn animsition-link line-hor">
					...
					<div class="container">
						<div class="row">
							...
							<div class="mt80 text-center">
								<a href="<?php echo get_post_meta($post->ID, 'link5', true); ?>" class="btn animsition-link line-vert" data-sr>
				...
				<section class="pt150 pb150">
					...
					<div class="container mt70">
						<div class="text-center">
							<a href="<?php echo get_post_meta($post->ID, 'link9', true); ?>" class="btn animsition-link line-vert" data-sr>
