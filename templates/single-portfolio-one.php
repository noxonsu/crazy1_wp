			...
			<main>
						...
						<div class="row">
							<div class="col-md-12 mb30">
                                ...
                                <?php if( have_rows('gallery') ): while( have_rows('gallery') ) : the_row(); ?>
                                    <div class="owl-item"><img src="<?php the_sub_field('picture'); ?>" alt="<?php the_title(); ?>"></div>
                                <?php endwhile; endif; ?>
								</div>
								<!-- End single-work-slider -->
							</div>
                            <?php if( have_rows('lower_gallery') ): while( have_rows('lower_gallery') ) : the_row(); ?>
                            <div class="col-sm-4 sm-mb30">
								<img src="<?php the_sub_field('picture2'); ?>" alt="<?php the_title(); ?>">
							</div>
                            <?php endwhile; endif; ?>
						</div>
					</div>
				...
				<section class="pt150 pb150">
					...
					<div class="container">
                        ...
                        <?php query_posts($result_filter); if ( have_posts() ) : while ( have_posts() ) : the_post(); $ff++; ?>
							<div class="crazy-portfolio-item">
								<a href="<?php the_permalink();?>" class="animsition-link">
									...
									<div class="figure <?php echo figur($ff); ?>"></div>
